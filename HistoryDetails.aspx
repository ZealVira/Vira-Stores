<%@ Page Title="" Language="C#" MasterPageFile="~/BasicLayout.Master" AutoEventWireup="true" CodeBehind="HistoryDetails.aspx.cs" Inherits="proj1.HistoryDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="padding-left: 20%; font-size: larger;">
    <asp:Label ID="Label1" runat="server" ForeColor="Red" Font-Size="Larger" Font-Bold="true"> </asp:Label>

        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" OnRowDataBound="GridView2_RowDataBound" Font-Size="X-Large"  >
            <Columns>
                <asp:BoundField DataField="ProductName" HeaderText="ProductName" SortExpression="ProductName" ItemStyle-Width="450" />
                <asp:BoundField DataField="Quantity" HeaderText="Quantity" SortExpression="Quantity" ItemStyle-Width="100" />
            </Columns>
        </asp:GridView>
    ...
    <center>
        <asp:Button ID="Button1" runat="server" Text="Done" CssClass="orderButton" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" Text="Download Invoice" CssClass="orderButton" OnClick="Button2_Click" />
